...
const getDefaultCurrency = (lang: string): 'USD' | 'RUB' => {
...
export const LoginPage = () => {
  ...
  const [currency, setCurrency] = useState<'USD' | 'RUB'>(getDefaultCurrency(i18n.language));
  ...
  const handleLanguageChange = (lang: string) => {
    ...
    setCurrency(getDefaultCurrency(lang));
  };
